...
class searchMemberComponent extends StatefulWidget {
  var memberData;

  searchMemberComponent(this.memberData);

  @override
  _searchMemberComponentState createState() => _searchMemberComponentState();
}

class _searchMemberComponentState extends State<searchMemberComponent> {
  String chepterId;
                          ...
                          Container(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(
                                widget.memberData["Status"] == "Requested"
                                    ? "1-2-1 Requested"
                                    : widget.memberData["Status"] == "Accepted"
                                        ? "1-2-1 Accepted"
                                        : widget.memberData["Status"] ==
                                                "Completed"
                                            ? "1-2-1 Completed"
