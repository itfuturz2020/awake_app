...
class CommitteeMemberDetail extends StatefulWidget {
  var memberData;

  CommitteeMemberDetail(this.memberData);

  @override
  _CommitteeMemberDetailState createState() => _CommitteeMemberDetailState();
}

class _CommitteeMemberDetailState extends State<CommitteeMemberDetail> {
  @override
