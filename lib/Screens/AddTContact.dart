...
class AddTContact extends StatefulWidget {
  var memberData;

  AddTContact({this.memberData});
  @override
  _AddTContactState createState() => _AddTContactState();
}

class _AddTContactState extends State<AddTContact> {
                ...
                child: Padding(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      TextFormField(
                        initialValue: "${widget.memberData["Mobile"]}",
