...
class GoldAchievementDetail extends StatefulWidget {
  var goldData;
  GoldAchievementDetail(this.goldData);
  @override
  _GoldAchievementDetailState createState() => _GoldAchievementDetailState();
}

class _GoldAchievementDetailState extends State<GoldAchievementDetail> {
  @override
              ...
              Container(
                  ...
                  child: Column(
                    children: <Widget>[
                          ...
                          child: AvatarGlow(
                            ...
                            child: Material(
                              ...
                              child: CircleAvatar(
                                ...
                                child: ClipOval(
                                    child: widget.goldData["Image"] == null ||
                      ...
                      widget.goldData["Address"] != null &&
                              widget.goldData["Address"] != ""
                          ? Padding(
                          ...
                          : Container(),
                      widget.goldData["Email"] != null &&
                              widget.goldData["Email"] != ""
                          ? Padding(
                              padding: const EdgeInsets.fromLTRB(25, 15, 25, 0),
                              child: Row(
                                children: <Widget>[
                          ...
                          : Container(),
                      widget.goldData["Mobile"] != null &&
                              widget.goldData["Mobile"] != ""
                          ? Padding(
                              padding:
                      ...
                      /*Padding(
                        ...
                        child: Text(
                          "${widget.goldData["RegionalTeamType"]}",
                          style: TextStyle(fontSize: 13),
                        ),
                      ),*/
                    ],
