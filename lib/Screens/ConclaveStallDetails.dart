...
class ConclaveStallDetails extends StatefulWidget {
  var stallData;

  ConclaveStallDetails({this.stallData});

  @override
  _ConclaveStallDetailsState createState() => _ConclaveStallDetailsState();
}

class _ConclaveStallDetailsState extends State<ConclaveStallDetails> {
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      print("IMG_URL${widget.stallData["VCF"]}");
                    },
                    child: Icon(
                      Icons.person_add,
                      size: 30,
